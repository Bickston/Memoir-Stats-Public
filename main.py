...
# Params: pdf_text, min_occurrences=2, alpha_only=False
...
# Params: pdf_text, dictionary_path, min_occurrences=40, no_dic=False
...
# TODO: compare word frequency // individual word count
